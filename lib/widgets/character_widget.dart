...
//import 'package:travel_app/pages/character_detail_screen.dart';
//import 'package:despicables_me_app/styleguide.dart';
import 'package:flutter/material.dart';
import 'package:travelapp/models/character.dart';
import 'package:travelapp/pages/character_detail_screen.dart';
        ...
        builder: (context, child) {
          ...
          return Stack(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 48, right: 16, bottom: 40),
                child: Column(
